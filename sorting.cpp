...
template <typename T, typename Func>
 ContainerRange particionar(T* arr, ContainerRange first, ContainerRange last, Func pComp) {
...
template <typename T, typename Func>
 void Merge(T* arr, const ContainerRange left, const ContainerRange mid   ,     const ContainerRange right, Func pComp) {
...
template <typename T, typename Func>
 void MergeSort( T* arr, ContainerRange const begin, ContainerRange const end, Func pComp) {
     if (begin >= end)
